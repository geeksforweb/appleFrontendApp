    ...
    <>
      <footer className="footer-wrapper">
        <div className="container">
          ...
          <div className="fs-4 disclaimer">
            <p>
              Disclaimer: This website is a UI clone of popular platforms such
              as apple created solely for educational and learning purposes.
              This project is not affiliated with, endorsed by, or connected to
              apple. All trademarks and brand names belong to their respective
              owners.
            </p>
          </div>
        </div>
